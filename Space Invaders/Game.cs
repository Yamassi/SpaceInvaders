...
public class Game
{
    ...
    public Game(GameConfiguration gameConfiguration)
    {
        ...
        _background.Texture = TextureManager.BackgroungTexture;

        _player = CreatePlayer(gameConfiguration);
        _screenSize = new Vector2f(gameConfiguration.Width, gameConfiguration.Height);
        _animationManager = new AnimationManager();
        _enemyManager = new EnemyManager(gameConfiguration.EnemySpawnCooldown,
            gameConfiguration.EnemySpeed, _screenSize, _animationManager);
    ...
    private Player CreatePlayer(GameConfiguration gameConfiguration)
    {
        ...
        var shootingManager = new ShootingManager(shootingCooldown,
            gameConfiguration.BulletSpeed,
        ...
        return new Player(shootingManager,
            shootingButton,
    ...
    private void ShowGameOverText()
    {
        ...
        var gameOverText = new TextLabel("Game\nOver", "FreeMonospacedBold", 80,
            Color.White, textPosition);
